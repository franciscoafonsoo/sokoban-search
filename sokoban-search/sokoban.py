                        ...
                        if canto1_x == canto2_x:
                            ...
                            for i in range(canto1_y, canto2_y):
                                ...
                                if (
                                    ...
                                    and self.tabuleiro_inicial[canto1_x][i] != TARGET
                                ):
...
def hung_alg_manh_usher_to_box(nodo):
    """ Algoritmo hungaro + heur_euclidean_usher_target """
    m = Munkres()
...
def hung_alg_manh(nodo):
    """ Algoritmo hungaro + heur_euclidean_usher_box """
    m = Munkres()
...
def import_sokoban_file(filename):
    ...
    :return: objecto do tipo EstadoSokoban()
    """
